  ...
  public partial class SupplierProfile
  {
    public void GetSupplierByIdMapping()
    {
      CreateMap<Entitis.Supplier, GetSupplierByIdResult>().
        ...
        ForMember(destnation => destnation.PurchaseInvoices, opt => opt.MapFrom(src => src.PurchaseInvoices)).ForMember(destnation => destnation.SupplierPayments, opt => opt.MapFrom(src => src.SupplierPayments));
    }
  }
}
